...
export default class DaftarSlo extends Component {
    ...
    renderItemComponent = (data,index) =>
        ...
        onPress={()=>Actions.UpdateSlo({
          PermohonanId: data.item._id,
          typePermohonan:data.item.typePermohonan,
          namaKapal: data.item.kapal.namaKapal,
          namaPanggilanKapal: data.item.kapal.namaPanggilanKapal,
          namaNahkoda: data.item.kapal.namaNahkoda,
          benderaKapal: data.item.kapal.benderaKapal,
          tempatTandaSelar: data.item.kapal.tempatTandaSelar,
          ...
          nomorTransmitter: data.item.nomorTransmitter,
          masaBerlakuTransmitter: data.item.masaBerlakuTransmitter,
          jenisAlatTangkap: data.item.jenisAlatTangkap,
          namaTanggalSLOAsal: data.item.namaTanggalSLOAsal,
          nomorTanggalTerbitSPB: data.item.nomorTanggalTerbitSPB,
          jenisIkan: data.item.jenisIkan,
          jumlah: data.item.jumlah,
          keadaan: data.item.keadaan,
          siup: data.item.siup,
          grosse: data.item.grosse,
          bkp: data.item.bkp,
          suratUkurKapal: data.item.suratUkurKapal,
          sipiSikpi: data.item.sipiSikpi,
          sloAsal: data.item.sloAsal,
          skat: data.item.skat,
          crewList: data.item.crewList,
          sertifikasiHam: data.item.sertifikasiHam,
          suratPernyataan: data.item.suratPernyataan,
        })}
        >
              <View 
              ...
              >
                <View style={styles.headerContentStyle}>
                          ...
                          <Text style={styles.title}>Nomor SIPI : {data.item.nomorSPI}</Text>
