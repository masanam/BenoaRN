...
export default class ListLvhpi extends Component {
          constructor(props) {  
     ...
     componentDidMount() {
          let url = 'http://marinir.herokuapp.com/permohonan/get/lvhpi/'+ this.state.userId;
              ...
              <View style={styles.card}>
                ...
                <View style={styles.thumbnailContainerStyle}>
                    <Image 
                        ...
                        source={{uri:'https://via.placeholder.com/400x200/4682B4/000000'}}
                    />
                </View>
    ...
    const { navigate } = this.props.navigation;  
      return (
        ...
        <SafeAreaView style={{ flex: 1 }}>
              <View>
              <Header
                    Title ={"Daftar Laporan Verifikasi HPI"}
                    back= {true}
                />
              </View>
