...
export default class DetailHPK2 extends Component {
  state = {
     isVisible: false,
    avatarSource : null,
    fotoNPWP : null,
...
//     console.log(data);
    ToastAndroid.show('Update Kedatangan Sukses', ToastAndroid.SHORT);
//     setTimeout(() =>
//                 {
               ...
               <View style={styles.content}>
                   ...
                   <View style={styles.cardContent}>
                       ...
                       <View style={styles.formPengangkut}>
                            <Text style={styles.namaKapal}>Jenis Ikan </Text>
                       </View>
                       <TextInput
                          multiline={true}
                          numberOfLines={4}
                         ...
                         <View style={styles.formPengangkut}>
                            <Text style={styles.namaKapal}>Jumlah Ikan </Text>
                       </View>
                       <TextInput
                          multiline={true}
                          numberOfLines={4}
